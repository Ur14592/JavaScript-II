...
let fullNames = [];
runners.forEach(a => fullNames.push(a.first_name +" "+ a.last_name))
...
// Problem 1
//All attendees from Kwimbee cant attend the race, find all Kwimbee attendees. 
let runnerCompanyName = runners.filter(x => x.company_name === "Kwimbee")
console.log(runnerCompanyName);


// Problem 2
// Everyone who donated over $200 will get a free lunch voucher.
let donation = runners.filter(x => x.donation > 200);
console.log(donation);



// Problem 3
// Need everyones emails in upper case. 
let emails = runners.map(x => x.email.toUpperCase());
console.log(emails);